...
export const REMOTE_CAMPAIGNS_UPDATE = 'REMOTE_CAMPAIGNS_UPDATE';
export const REMOTE_DECKS_UPDATE = 'REMOTE_DECKS_UPDATE';
export const MIGRATE_CAMPAIGN_DATA = 'MIGRATE_CAMPAIGN_DATA';
